...
function productListReducer (state= {productos:[]}, action) {
...
function productDetailsReducer (state= {producto:{} }, action) {
...
function productSaveReducer (state= {producto:{} }, action) {
...
function productDeleteReducer (state= {producto:{} }, action) {
